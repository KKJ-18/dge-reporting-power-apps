...
import { ClientPhotoMetadata } from '../Models/Office365UsersModel';
import { dataSourcesInfo } from '../../.power/appschemas/dataSourcesInfo';
import { EntityListResponse } from '../Models/Office365UsersModel';
import { extractSensitivityLabel } from '../Models/Office365UsersModel';
import { fetchSensitivityLabelMetadata } from '../Models/Office365UsersModel';
import { getPowerSdkInstance, IOperationResult } from '@pa-client/power-code-sdk/lib/';
import { GraphTrending } from '../Models/Office365UsersModel';
import { GraphUser_V1 } from '../Models/Office365UsersModel';
import { GraphUserUpdateable_V1 } from '../Models/Office365UsersModel';
import { LinklessEntityListResponse } from '../Models/Office365UsersModel';
import { ObjectWithoutType } from '../Models/Office365UsersModel';
import { User } from '../Models/Office365UsersModel';
...
export class Office365UsersService {
   ...
   * Get relevant people.
   */
  public static async RelevantPeople(userId: string): Promise<IOperationResult<LinklessEntityListResponse>> {
    const parameters: { userId: string } = { userId };
    const result = await getPowerSdkInstance(dataSourcesInfo).Data.executeAsync<{ userId: string }, LinklessEntityListResponse>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
   ...
   */
  public static async SearchUserV2(searchTerm: string, top: number, isSearchTermRequired: boolean, skipToken: string): Promise<IOperationResult<EntityListResponse>> {
    ...
    const result = await getPowerSdkInstance(dataSourcesInfo).Data.executeAsync<{ searchTerm: string, top: number, isSearchTermRequired: boolean, skipToken: string }, EntityListResponse>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
   ...
   */
  public static async TrendingDocuments(id: string, $filter: string, extractsensitivitylabel: extractSensitivityLabel, fetchsensitivitylabelmetadata: fetchSensitivityLabelMetadata): Promise<IOperationResult<{ value: GraphTrending[] }>> {
    const parameters: { id: string, $filter: string, extractsensitivitylabel: extractSensitivityLabel, fetchsensitivitylabelmetadata: fetchSensitivityLabelMetadata } = { id, $filter, extractsensitivitylabel, fetchsensitivitylabelmetadata };
    const result = await getPowerSdkInstance(dataSourcesInfo).Data.executeAsync<{ id: string, $filter: string, extractsensitivitylabel: extractSensitivityLabel, fetchsensitivitylabelmetadata: fetchSensitivityLabelMetadata }, { value: GraphTrending[] }>({
      connectorOperation: {
        tableName: Office365UsersService.dataSourceName,
